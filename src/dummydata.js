...
export const news = [
  ...
  //   desc: "One of Investment Management Financial engage with Mastersystem Infotama a major IT consultancy and an Amazon Web Services (AWS) Partner, to help migrate, backup on-premises server and application workloads ",
  //   cover: "../images/sucess/AWS Success Story Banner.jpg",
  // },
