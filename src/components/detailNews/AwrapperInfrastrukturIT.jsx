    ...
    <>
      <section className='homeAbout' id="sukses_aws">
        ...
        <div className=" bg-white">
          ...
          <br />
          <h5>3.	Auto Scaling Group (ASG)</h5>
          <ul style={{ paddingLeft: '20px' }}>
          ...
          <br />
          <h5>1.	Operational Excellence (Kemudahan Operasi)</h5>
          <ul style={{ paddingLeft: '20px' }}>
          ...
          <br />
          <h5>2.	Security (Keamanan Data)</h5>
          <ul style={{ paddingLeft: '20px' }}>
          ...
          <br />
          <h5>3.	Reliability (Keandalan Sistem)</h5>
          <ul style={{ paddingLeft: '20px' }}>
          ...
          <br />
          <h5>4.	Performance Efficiency (Kinerja Optimal)</h5>
          <ul style={{ paddingLeft: '20px' }}>
          ...
          <br />
          <h5>5.	Cost Optimization (Biaya Efisien)</h5>
          <ul style={{ paddingLeft: '20px' }}>
          ...
          <br />
          <h5>6.	Sustainability (Keberlanjutan & Ramah Lingkungan)</h5>
          <ul style={{ paddingLeft: '20px' }}>
