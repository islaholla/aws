      ...
      <section className='homeAbout' id="sukses_aws">
        ...
        <div className=" bg-white">
          ...
          <ul style={{ paddingLeft: '20px' }}>
            ...
            <li>• Integrated third party Next-Generation Firewall (NGFW) solution on Amazon AWS to enhance security for VPN clients, ensuring secure remote access and network protection.</li>
          </ul>
          <br />
...
export default AwrapperInvestment
